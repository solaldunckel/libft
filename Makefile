...
NAME	= libft.a
SRCS	= $(addprefix ${FOLDER}/, ft_atoi.c ft_isalnum.c ft_isalpha.c \
			ft_isdigit.c ft_strlen.c ft_isascii.c ft_isprint.c ft_toupper.c \
			ft_tolower.c ft_strchr.c ft_strrchr.c ft_strncmp.c ft_strlcpy.c \
			ft_strlcat.c ft_strnstr.c ft_memcpy.c ft_memccpy.c ft_bzero.c \
			ft_memset.c ft_memmove.c ft_memchr.c ft_memcmp.c ft_calloc.c \
			ft_strdup.c ft_strstr.c ft_putchar.c ft_strcat.c ft_strcpy.c \
			ft_putnbr.c ft_putstr.c ft_substr.c ft_strjoin.c ft_strtrim.c \
			ft_split.c ft_intlen.c ft_itoa.c ft_strmapi.c ft_putchar_fd.c \
